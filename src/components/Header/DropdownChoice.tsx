...
export default function DropdownChoice({ label, selected, onPress }: Props) {
    return (
        <InteractivePressable accessibilityRole="radio" accessibilityState={{ checked: selected }} onPress={onPress}
...
const styles = StyleSheet.create({
    option: { minHeight: 40, padding: 5, borderRadius: 6, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
